...
@RestController
@RequestMapping("/api")
@Api(description = "Operations on top rated books.")
public class BookResource {
    ...
    @ApiOperation(value = "Creates a new book entry in the top rated books.")
    ...
    @ApiOperation(value = "Updates a book entry in the top rated books.")
    ...
    @ApiOperation(value = "Returns all the top rated books.")
    ...
    @ApiOperation(value = "Returns a top rated book giving its identifier.")
    ...
    @ApiOperation(value = "Deletes a top rated book giving its identifier.")
